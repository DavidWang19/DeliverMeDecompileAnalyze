namespace Utage
{
    ...
    internal class AdvCommandRuleFadeOut : AdvCommandEffectBase
    {
        ...
        public AdvCommandRuleFadeOut(StringGridRow row) : base(row)
        {
        ...
        protected override void OnStartEffect(GameObject target, AdvEngine engine, AdvScenarioThread thread)
        {
            ...
            {
                componentInChildren.RuleFadeOut(engine, this.data, new Action(storey.<>m__0));
            }
        }
        ...
        {
            internal AdvCommandRuleFadeOut $this;
